...
<body>
    ...
    <nav class="navbar navbar-expand-lg" style="z-index: 1000;">
        <div class="container">
            <a class="navbar-brand text-uppercase fw-bold" href="#">Dress </a>
            ...
            <div class="container">
                <footer class="py-5">
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
                        <p>&copy; 2025 <a href="#" class="text-decoration-none text-white">Denis maka</a>, Tous droits réservés.</p>
